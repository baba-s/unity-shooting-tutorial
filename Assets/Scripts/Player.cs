...
public class Player : MonoBehaviour
{
	...
	public void AddExp( int exp )
	{
		...
		m_shotCount = Mathf.RoundToInt( Mathf.Lerp( 1, 4, t ) ); // 弾の発射数
		m_shotInterval = Mathf.Lerp( m_shotIntervalFrom, m_shotIntervalTo, t ); // 弾の発射間隔（秒）
	...
	{
		/*
		 * 例えば、m_nextExpBase が 20、m_nextExpInterval が 16 の場合、
		 *
		 * レベル 1：16 + 18 * 0 = 16
		 * レベル 2：16 + 18 * 1 = 34
		 * レベル 3：16 + 18 * 4 = 88
